...
My vim dot files. the `.vimrc` file is saved to [vimrc](https://github.com/volcomism/vimrc/blob/master/vimrc).

Just run the following commands via terminal to get perfectly set up:

```console
$ cd ~/
$ git clone --recursive https://github.com/volcomism/vimrc.git .vim
$ ln -sf $HOME/Projects/vimrc/vimrc $HOME/.vimrc
$ cd $HOME/Projects/vimrc
